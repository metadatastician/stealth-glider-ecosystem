...
#
# Stealth Glider Ecosystem — Cerro Torre build, sign, and verify pipeline
#
...
#   CT_KEY_ID       — Signing key identifier (default: stealth-glider-ecosystem-release)
