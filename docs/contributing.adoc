...
= Contributing — Stealth Glider Ecosystem
:revdate: 2026-MM-DD

== Audience

Developers working *on* `Stealth Glider Ecosystem`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:metadatastician/Stealth Glider Ecosystem.git
...
* Bugs in `Stealth Glider Ecosystem`: file at `metadatastician/Stealth Glider Ecosystem/issues`.
