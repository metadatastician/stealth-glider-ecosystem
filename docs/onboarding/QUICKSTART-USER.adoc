...
// Replace stealth-glider-ecosystem, Rsr Template Repo — See README.adoc for details., just run, Rsr Template Repo started successfully. with actuals
= stealth-glider-ecosystem — Quick Start for Users
:toc:
:toclevels: 2

== What is stealth-glider-ecosystem?
...
[source,bash]
----
just install --portable --prefix=./stealth-glider-ecosystem-portable
----
