...
// Replace stealth-glider-ecosystem, UNASSIGNED, UNASSIGNED with actuals
= stealth-glider-ecosystem — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining stealth-glider-ecosystem for
...
podman build -t stealth-glider-ecosystem .
----
...
* Upstream: https://github.com/metadatastician/stealth-glider-ecosystem/issues
